...
var profileSchema = new Schema({
    ...
    nganhHoc: {type: Schema.Types.String, ref: 'NganhHoc',  sparse: true},
    truong: {type: Schema.Types.String, ref: 'Truong',  sparse: true},
    idPhong: {type: Schema.Types.String, ref: 'Phong',  sparse: true},
    moTa: String,
    sdtNguoiThan: String,
    ngayVaoO: Date,
    nam: Number,
